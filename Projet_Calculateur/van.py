...
class Van(tk.Tk):
    def __init__(self):
        ...
        #Input labels
        self.kwh_input = tk.Entry(self, width = 30, textvariable = self.kwh).grid(row = 2, column = 2, columnspan = 2)
        self.taux_input = tk.Entry(self, width = 30, textvariable = self.taux).grid(row = 3, column = 2, columnspan = 2)
        self.inv_input = tk.Entry(self, width = 30, textvariable = self.inv).grid(row = 4, column = 2, columnspan = 2)
        self.capacite_entry=tk.Entry(self, width = 30, textvariable = self.capacite).grid(row = 5, column = 2, columnspan = 2)
